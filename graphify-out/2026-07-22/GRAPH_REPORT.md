...
## Corpus Check
- 154 files · ~90,317 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 963 nodes · 1876 edges · 69 communities (61 shown, 8 thin omitted)
...
Cohesion: 0.06
Nodes (49): AdminUserCreate, AnamnesisList, CheckoutConfig, coerceAddons(), coerceLimits(), decodeJwtPayload(), DemoRequestConfirmation, DemoRequestPayload (+41 more)
...
Cohesion: 0.10
Nodes (31): getSecretariaHubToken(), AppointmentCancelPayload, AppointmentCreatePayload, AppointmentReschedulePayload, AppointmentStatusWire, AppointmentTypeWire, AppointmentWire, BlockCreatePayload (+23 more)
...
### Community 7 - "ui.tsx"
Cohesion: 0.13
Nodes (18): BrandIcon(), BrandIconProps, FILLED, IconName, PATHS, Faq(), FaqItem, FaqProps (+10 more)
...
Cohesion: 0.15
Nodes (12): ADMIN_NAV, AdminLayout(), PortalNavItem, PortalShell(), PortalShellProps, DOCTOR_NAV, DoctorLayout(), DoctorNavItem (+4 more)
...
Cohesion: 0.16
Nodes (13): DrawerProps, CSelectProps, ApptStatus, firstLetter(), STATUS_META, Avatar(), Btn(), BtnSize (+5 more)
...
Cohesion: 0.18
Nodes (9): CToast(), CToastProps, SectionProps, NAV, NavItem, SideNav(), SideNavProps, Icon() (+1 more)
...
Cohesion: 0.11
Nodes (23): AddressFieldsOfCtx, applyWireAddress(), applyWireAppointmentTypes(), applyWireBusinessHours(), applyWireInsurances(), applyWireMessages(), applyWirePostConsult(), applyWireProfessionalProfile() (+15 more)
...
Cohesion: 0.16
Nodes (15): AdminDashboardPage(), Stats, adminGetEntitlements(), adminGetInbound(), adminGetTenant(), adminListDemoRequests(), adminListTenants(), adminListUsers() (+7 more)
...
Cohesion: 0.08
Nodes (23): ActivateButton(), ActivateButtonProps, PauseToggles(), PauseTogglesProps, NODES, rankOf(), StateTimeline(), ATTEMPT_RESULT_LABEL (+15 more)
...
Cohesion: 0.10
Nodes (25): AddressFields(), AddressFieldsProps, ContextSection(), ContextSectionProps, CSelect(), GoogleGlyph(), GoogleSection(), GoogleSectionProps (+17 more)
...
Cohesion: 0.20
Nodes (7): Anamnese, APPT_TYPES, DURATIONS, SEED_APPTS, SEED_BLOCKS, StatusTone, WeekDay
...
Cohesion: 0.15
Nodes (14): currentWeekIsoRange(), mapHubEventsToAppts(), mapHubEventToAppt(), mondayOfWeek(), slotToIsoRange(), ModalState, ToastState, ViewMode (+6 more)
...
Cohesion: 0.22
Nodes (6): ProfessionalsSection(), ProfessionalsSectionProps, ProfessionalProfile, createSelfProfessional(), DoctorProfessional, startProfessionalCalendarOauth()
...
Cohesion: 0.33
Nodes (6): AgendaPage(), ConfiguracaoPage(), demoWeek(), useSecretariaHub(), UseSecretariaHubResult, hubConfigured()

## Knowledge Gaps
- **292 isolated node(s):** `DashFiltersProps`, `DashHeaderProps`, `SIZE_OPTIONS`, `DashPaginationProps`, `DashSearchProps` (+287 more)
...
- **Why does `Session` connect `Session` to `manage-api.ts`, `useSecretariaHub.ts`, `page.tsx`, `usePortalGuard`, `secretaria-hub.ts`, `manage-api.test.ts`, `page.tsx`, `page.tsx`, `page.tsx`, `Session`, `page.tsx`, `sign-out.test.ts`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **Why does `ManageApiError` connect `page.tsx` to `manage-api.ts`, `useSecretariaHub.ts`, `usePortalGuard`, `page.tsx`, `secretaria-hub.ts`, `BrandIcon.tsx`, `data.ts`, `page.tsx`, `PlanCheckoutCta.tsx`, `page.tsx`, `page.tsx`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Why does `BrandIcon()` connect `ui.tsx` to `page.tsx`, `BrandHeader.tsx`, `usePortalGuard`, `BrandIcon.tsx`, `page.tsx`, `Session`, `page.tsx`, `page.tsx`?**
