"use client";
// GoogleSection — Section 07 "Integração com o Google Calendar".
...
// ProfessionalsSection (Section 04).
...
// Section 07 — Google Calendar OAuth connect/disconnect + settings when connected.
