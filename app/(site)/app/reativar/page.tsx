...
// teste" action. Sibling route to /app/onboarding and /app/billing — same
// dash-header/dash-main chrome; guarded like the /doctor/* portal via
// usePortalGuard (mirrors ../onboarding/page.tsx's guard+shell pattern exactly).
              ...
              <>
                ...
                {paymentNotice && (
                  <div className="rtv-payment-notice" role="status">
                    Não encontramos uma forma de pagamento cadastrada.{" "}
                    <Link href="/app/billing" style={{ fontWeight: 700, textDecoration: "underline" }}>
                      Adicione uma
                    </Link>{" "}
                    para garantir a cobrança assim que a Meta aprovar.
                  </div>
                )}
              </>
            )}
