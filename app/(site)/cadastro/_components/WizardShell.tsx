...
// header (brand mark, links back to the marketing site), a progress bar, and
// a centered card. Mirrors the look of /checkout/sucesso's CheckoutShell
// (checkout.css) rather than the ported-PreCheck AuthShell, since this wizard
// is reached from Brain marketing CTAs and must read as Brain, not PreCheck.
