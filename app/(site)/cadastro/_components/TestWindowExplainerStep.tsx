...
// before SummaryStep, for secretarIA purchases only (same gate as AddonsStep — see
// CadastroWizard's nextAfterEligibility). This is the FULL, first explanation of how
// billing actually works: a WhatsApp Coexistence connection-test window, not a "free
// trial." CheckoutTrialNotice (rendered again, smaller, on SummaryStep right above the
