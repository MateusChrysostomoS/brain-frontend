...
// checkout step, ONLY for a secretarIA purchase (CadastroWizard gates entry into
// this step by plan.planId; see nextAfterEligibility). Renders one toggle card per
